...
system(paste0("mkdir -p ",dir,"data/processed/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/"))
...
group5 <- h5ls(paste0(dir,"data/processed/",sp6,"_vs_",sp1,"/",sp6,"_vs_",sp1,".h5"))$group[2]
group6 <- h5ls(paste0(dir,"data/processed/",sp7,"_vs_",sp1,"/",sp7,"_vs_",sp1,".h5"))$group[2]
group7 <- h5ls(paste0(dir,"data/processed/",sp8,"_vs_",sp1,"/",sp8,"_vs_",sp1,".h5"))$group[2]
group8 <- h5ls(paste0(dir,"data/processed/",sp9,"_vs_",sp1,"/",sp9,"_vs_",sp1,".h5"))$group[2]
...
headers5 <- h5ls(paste0(dir,"data/processed/",sp6,"_vs_",sp1,"/",sp6,"_vs_",sp1,".h5"))$name; headers <- unique(intersect(headers,headers5))
headers6 <- h5ls(paste0(dir,"data/processed/",sp7,"_vs_",sp1,"/",sp7,"_vs_",sp1,".h5"))$name; headers <- unique(intersect(headers,headers6))
headers7 <- h5ls(paste0(dir,"data/processed/",sp8,"_vs_",sp1,"/",sp8,"_vs_",sp1,".h5"))$name; headers <- unique(intersect(headers,headers7))
headers8 <- h5ls(paste0(dir,"data/processed/",sp9,"_vs_",sp1,"/",sp9,"_vs_",sp1,".h5"))$name; headers <- unique(intersect(headers,headers8))
...
rTable <- foreach(header=headers, .inorder=FALSE, .combine=combine_tables) %dopar%
{
  ...
  intervals5 <- as.data.table(as.matrix(h5read(paste0(dir,"data/processed/",sp6,"_vs_",sp1,"/",sp6,"_vs_",sp1,".h5"), paste0(group5,"/",header))))
  intervals6 <- as.data.table(as.matrix(h5read(paste0(dir,"data/processed/",sp7,"_vs_",sp1,"/",sp7,"_vs_",sp1,".h5"), paste0(group6,"/",header))))
  intervals7 <- as.data.table(as.matrix(h5read(paste0(dir,"data/processed/",sp8,"_vs_",sp1,"/",sp8,"_vs_",sp1,".h5"), paste0(group7,"/",header))))
  intervals8 <- as.data.table(as.matrix(h5read(paste0(dir,"data/processed/",sp9,"_vs_",sp1,"/",sp9,"_vs_",sp1,".h5"), paste0(group8,"/",header))))
...
write.table(data.frame(r=as.integer(names(rTable)),m=as.numeric(rTable)),paste0(dir,"data/processed/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,".tsv"),append=FALSE,row.names=FALSE,col.names=FALSE,sep = "\t",quote=FALSE)
...
write.table(intersects,paste0(dir,"data/processed/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"_intersects.bed"),append=FALSE,row.names=FALSE,col.names=FALSE,sep = "\t",quote=FALSE)

# EXTRACT SEQUENCES
library(seqinr)
seqs <- read.fasta("/scratch/ws1/msheinman-msheinman/ThreeFold/data/external/Cronobacter.fna")
locs <- read.delim(paste0(dir,"data/processed/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"_intersects.bed"), header=F, sep="\t") # Tabs? Put sep="\t"
outf <- file(paste0(dir,"data/processed/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/",sp9,"_vs_",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"_intersects.fa"), 'w')
