...
system(paste0("mkdir -p ",dir,"data/processed/",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/"))
...
write.table(data.frame(r=as.integer(names(rTable)),m=as.numeric(rTable)),paste0(dir,"data/processed/",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,"/",sp8,"_vs_",sp7,"_vs_",sp6,"_vs_",sp5,"_vs_",sp4,"_vs_",sp3,"_vs_",sp2,"_vs_",sp1,".tsv"),append=FALSE,row.names=FALSE,col.names=FALSE,sep = "\t",quote=FALSE)
