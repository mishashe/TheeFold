...
system(paste0("mkdir -p ",dir,"data/processed/",sp8,"_",sp7,"_",sp6,"_",sp5,"_",sp4,"_",sp3,"_",sp2,"_",sp1,"/"))
...
write.table(data.frame(r=as.integer(names(rTable)),m=as.numeric(rTable)),paste0(dir,"data/processed/",sp8,"_",sp7,"_",sp6,"_",sp5,"_",sp4,"_",sp3,"_",sp2,"_",sp1,"/",sp8,"_",sp7,"_",sp6,"_",sp5,"_",sp4,"_",sp3,"_",sp2,"_",sp1,".tsv"),append=FALSE,row.names=FALSE,col.names=FALSE,sep = "\t",quote=FALSE)
