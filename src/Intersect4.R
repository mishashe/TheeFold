...
system(paste0("mkdir -p ",dir,"data/processed/",sp4,"_",sp3,"_",sp2,"_",sp1,"/"))
...
write.table(data.frame(r=as.integer(names(rTable)),m=as.numeric(rTable)),paste0(dir,"data/processed/",sp4,"_",sp3,"_",sp2,"_",sp1,"/",sp4,"_",sp3,"_",sp2,"_",sp1,".tsv"),append=FALSE,row.names=FALSE,col.names=FALSE,sep = "\t",quote=FALSE)
...
# 
# 
# file12 <- paste0(dir,"data/processed/",sp2,"_",sp1,"/",sp2,"_",sp1,".tsv")
# file13 <- paste0(dir,"data/processed/",sp3,"_",sp1,"/",sp3,"_",sp1,".tsv")
# file14 <- paste0(dir,"data/processed/",sp4,"_",sp1,"/",sp4,"_",sp1,".tsv")
# file23 <- paste0(dir,"data/processed/",sp3,"_",sp2,"/",sp3,"_",sp2,".tsv")
# file24 <- paste0(dir,"data/processed/",sp4,"_",sp2,"/",sp4,"_",sp2,".tsv")
# file34 <- paste0(dir,"data/processed/",sp4,"_",sp3,"/",sp4,"_",sp3,".tsv")
# 
# file123 <- paste0(dir,"data/processed/",sp3,"_",sp2,"_",sp1,"/",sp3,"_",sp2,"_",sp1,".tsv")
# file124 <- paste0(dir,"data/processed/",sp4,"_",sp2,"_",sp1,"/",sp4,"_",sp2,"_",sp1,".tsv")
# file134 <- paste0(dir,"data/processed/",sp4,"_",sp3,"_",sp1,"/",sp4,"_",sp3,"_",sp1,".tsv")
# file234 <- paste0(dir,"data/processed/",sp4,"_",sp3,"_",sp2,"/",sp4,"_",sp3,"_",sp2,".tsv")
# 
# file1234 <- paste0(dir,"data/processed/",sp4,"_",sp3,"_",sp2,"_",sp1,"/",sp4,"_",sp3,"_",sp2,"_",sp1,".tsv")
# 
# {
#   legends <- c()
...
# 
# {
#   pdf(paste0(dir,"data/processed/",sp4,"_",sp3,"_",sp2,"_",sp1,"/",sp4,"_",sp3,"_",sp2,"_",sp1,"_MLD.pdf"),width=5,height=5)
