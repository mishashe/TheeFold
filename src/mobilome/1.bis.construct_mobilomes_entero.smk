...
configfile:"config_mobilome_entero.yml"
...
#		listFile=expand("{DATA_DIR}/external/list_samples/{{GENUS}}_csv",DATA_DIR=config["DATA_DIR"]),
		db = expand("{DATA_DIR_MOB}/external/database/nuc_db.fa",DATA_DIR=config["DATA_DIR"],DATA_DIR_MOB=config["DATA_DIR_MOB"]),
		pdb = expand("{DATA_DIR_MOB}/external/database/prot_db.fa",DATA_DIR=config["DATA_DIR"],DATA_DIR_MOB=config["DATA_DIR_MOB"])
	output:
